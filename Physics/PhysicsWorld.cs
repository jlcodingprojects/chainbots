...
namespace Chainbots.Physics
{
    ...
    public class PhysicsWorld : IPhysicsWorld
    {
            ...
            List<HexBlock> anchorBlocks)
        {
            ...
            {
                block.SetCollisionCategory(0x0002, 0x0002 | 0x0004 | 0x0008); // Now collide with ground too
            }
